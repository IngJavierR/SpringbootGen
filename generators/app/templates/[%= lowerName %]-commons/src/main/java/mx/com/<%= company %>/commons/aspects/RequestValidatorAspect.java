package mx.com.[%= company %].commons.aspects;

import mx.com.[%= company %].commons.exceptions.ForbiddenException;
import mx.com.[%= company %].commons.exceptions.NotFoundException;
import mx.com.[%= company %].commons.exceptions.ParametersException;
import mx.com.[%= company %].commons.exceptions.UnauthorizedException;
import mx.com.[%= company %].commons.to.ErrorTO;
...
public class RequestValidatorAspect {
    ...
    @Around(value = "execution(* mx.com.[%= company %].web.rest.*.*(..))  && args(..)")
